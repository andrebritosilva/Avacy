...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPDFST" )
				dbCloseAll()
			Else
...
ฑฑบ Programa ณ FSTProc  บ Autor ณ       Protheus     บ Data ณ  12/08/2017 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX6, { ;
	...
	'MV_XPRO001'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Descri็ใo Proteste Boleto Acelerador'									, ; //X6_DESCRIC
	'Descri็ใo Proteste Boleto Acelerador'									, ; //X6_DSCSPA
	'Descri็ใo Proteste Boleto Acelerador'									, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'Protestar 5 dias ap๓s o Vencimento'									, ; //X6_CONTEUD
	'Protestar 5 dias ap๓s o Vencimento'									, ; //X6_CONTSPA
	'Protestar 5 dias ap๓s o Vencimento'  									, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		} ) //X6_PYME
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Carteira de Cobran็a' )
aHlpEng := {}
aHlpSpa := {}
