...
If lTela .Or. Empty(AllTrim(cArq)) .Or. Empty(AllTrim(cOrigem)) 
   ...
   Define MsDialog oDlg Title 'Integração de Excel' From 10,16 To 30,80 OF oMainWnd         
      
      
     // @ nLin,nCol1  Say      'Arquivo :'                                Of oDlg Pixel  
     // @ nLin,nCol2  MsGet    oArq   Var cArq                 Size 130,09 Of oDlg Pixel  
      ...
      @ nLin,nCol1  Say      'Arquivo :'                                Of oDlg Pixel  
      nLin += 10
      @ nLin,nCol1 MsGet    oArq   Var cArq                 Size 130,09 Of oDlg Pixel  
